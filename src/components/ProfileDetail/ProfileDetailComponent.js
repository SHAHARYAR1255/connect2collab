                    ...
                    <div className="col-md-8 offset-md-4">
                        <div className="card card-skill">
                            <div className="card-body">
                                ...
                                <hr />
                                <p className="card-text"><i className="fa fa-thumb-tack text-info" aria-hidden="true"></i>&nbspHtml (intermediate)</p>
                                <p className="card-text"><i className="fa fa-thumb-tack text-info" aria-hidden="true"></i>&nbspCSS (intermediate)</p>
                                <p className="card-text"><i className="fa fa-thumb-tack text-info" aria-hidden="true"></i>&nbspReact (beginner)</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-8  offset-md-4 ">
                        <div className="card card-experience">
                            <div className="card-body">
                                ...
                                <div className="row">
                                    <div className="col-4">
                                        <img src="/assets/img/faces/inernsPak.png" className="img-fluid" />
                                    </div>
                                    <div className="col-8 pr-0 pl-0">
