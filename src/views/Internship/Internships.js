        ...
        <>
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <button type="button" class="btn btn-outline-secondary cs_skill_button">CSS</button>
            ...
            <div class="row cs_button_row">
                <a class="btn btn-primary cs_job_button" href="jobdetail.html" role="button">View Detail</a>
            </div>
        </div>
        </>
    )
